        ...
        const fetchProblem = async () => {
            try {
                ...
                reset({
                    ...
                    startCode: data.startCode || defaultValues.startCode,
                    referenceSolution: data.referenceSolution || defaultValues.referenceSolution,
                });
            } catch (error) {
                ...
                <div className="card bg-base-100 shadow-lg p-6">
                    ...
                    <div className="space-y-4 mb-6">
                        ...
                        {visibleFields.map((field, index) => (
                            <div key={field.id} className="border p-4 rounded-lg space-y-2">
                                <div className="flex justify-end"><button type="button" onClick={() => removeVisible(index)} className="btn btn-xs btn-error">Remove</button></div>
                    ...
                    <div className="space-y-4">
                        ...
                        {hiddenFields.map((field, index) => (
                            <div key={field.id} className="border p-4 rounded-lg space-y-2">
                                <div className="flex justify-end"><button type="button" onClick={() => removeHidden(index)} className="btn btn-xs btn-error">Remove</button></div>
